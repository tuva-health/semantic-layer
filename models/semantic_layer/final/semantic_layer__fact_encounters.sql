select
  ...
  , person_id
  , data_source
  , {{ the_tuva_project.concat_custom(["person_id", "'|'", "data_source"]) }} as patient_source_key
  , {{ the_tuva_project.concat_custom(["person_id", "'|'", the_tuva_project.yyyymm("encounter_start_date")]) }} as member_month_sk
